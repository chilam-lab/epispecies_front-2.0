  ...
  chartOptions: Highcharts.Options = {
    ...
    series: [
      ...
      },
      {
        ...
        pointPlacement: -0.2  // Adjusts positioning relative to columns
      },
      {
        name: 'Temperature',
        type: 'spline',
      ...
      },
      {
        ...
        pointPlacement: 0.1  // Adjusts positioning relative to spline
      }
    ]
  };
}
